...
<head>
    ...
    <title>Buat Pengguna - PLN UID Kalselteng</title>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 p-6 sm:p-8 md:p-10 overflow-x-hidden ml-64">
        <header class="mb-8">
            <h2 class="font-bold text-2xl sm:text-3xl text-gray-800 select-none">Buat Pengguna Baru</h2>
        </header>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-4">
                        ...
                        <input type="text" id="username" name="username" class="form-input @error('username') border-red-500 @enderror" value="{{ old('username') }}" required>
                        @error('username')
